      ...
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary shadow border-0">
            ...
            <form role="form" method="POST" action="{{('/admin-dashboard')}}">
                @csrf
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Email" type="email" name="aemail">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Password" type="password" name="apassword">
                  </div>
                </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          ...
          &copy; 2019 <a href="{{url('/')}}" class="font-weight-bold ml-1" target="_blank">E-Shopper</a>
          </div>
        </div>
        <div class="col-xl-6">
